...
test("submits bcs transaction", async () => {
    ...
    const entryFunctionPayload = new transaction_builder_1.TxnBuilderTypes.TransactionPayloadEntryFunction(transaction_builder_1.TxnBuilderTypes.EntryFunction.natural("0x1::coin", "transfer", [token], [(0, bcs_1.bcsToBytes)(transaction_builder_1.TxnBuilderTypes.AccountAddress.fromHex(account2.address())), (0, bcs_1.bcsSerializeUint64)(717)]));
...
test("submits multisig transaction", async () => {
    ...
    expect(accountResource.data.coin.value).toBe("0");
    const token = new transaction_builder_1.TxnBuilderTypes.TypeTagStruct(transaction_builder_1.TxnBuilderTypes.StructTag.fromString("0x1::aptos_coin::AptosCoin"));
    const entryFunctionPayload = new transaction_builder_1.TxnBuilderTypes.TransactionPayloadEntryFunction(transaction_builder_1.TxnBuilderTypes.EntryFunction.natural("0x1::coin", "transfer", [token], [(0, bcs_1.bcsToBytes)(transaction_builder_1.TxnBuilderTypes.AccountAddress.fromHex(account4.address())), (0, bcs_1.bcsSerializeUint64)(123)]));
...
test("submits json transaction simulation", async () => {
    ...
    const transactionRes = (await client.simulateTransaction(account1, txnRequest, { estimateGasUnitPrice: true, estimateMaxGasAmount: true }))[0];
...
test("submits bcs transaction simulation", async () => {
    ...
    const account1 = new aptos_account_1.AptosAccount();
    const account2 = new aptos_account_1.AptosAccount();
    const txns1 = await faucetClient.fundAccount(account1.address(), 500000000);
    ...
    const checkAptosCoin = async () => {
        ...
        const account1Resource = resources1.find((r) => r.type === aptosCoin);
        const account2Resource = resources2.find((r) => r.type === aptosCoin);
        expect(account1Resource.data.coin.value).toBe("500000000");
        expect(account2Resource.data.coin.value).toBe("100000000");
    };
    await checkAptosCoin();
    const token = new transaction_builder_1.TxnBuilderTypes.TypeTagStruct(transaction_builder_1.TxnBuilderTypes.StructTag.fromString("0x1::aptos_coin::AptosCoin"));
    const entryFunctionPayload = new transaction_builder_1.TxnBuilderTypes.TransactionPayloadEntryFunction(transaction_builder_1.TxnBuilderTypes.EntryFunction.natural("0x1::coin", "transfer", [token], [(0, bcs_1.bcsToBytes)(transaction_builder_1.TxnBuilderTypes.AccountAddress.fromHex(account2.address())), (0, bcs_1.bcsSerializeUint64)(1000)]));
    const rawTxn = await client.generateRawTransaction(account1.address(), entryFunctionPayload);
...
test("publishes a package", async () => {
    const client = new aptos_client_1.AptosClient(test_helper_test_1.NODE_URL);
    const faucetClient = new faucet_client_1.FaucetClient(test_helper_test_1.NODE_URL, test_helper_test_1.FAUCET_URL);
    const account1 = new aptos_account_1.AptosAccount(new hex_string_1.HexString("0x883fdd67576e5fdceb370ba665b8af8856d0cae63fd808b8d16077c6b008ea8c").toUint8Array());
    await faucetClient.fundAccount(account1.address(), 100000000);
    const txnHash = await client.publishPackage(account1, new hex_string_1.HexString(
    ...
    "").toUint8Array(), [
        new transaction_builder_1.TxnBuilderTypes.Module(new hex_string_1.HexString(
        // eslint-disable-next-line max-len
...
test("rotates auth key ed25519", async () => {
    ...
    expect(hex_string_1.HexString.fromUint8Array((0, bcs_1.bcsToBytes)(origAddress)).hex()).toBe(hex_string_1.HexString.fromUint8Array((0, bcs_1.bcsToBytes)(aliceAddress)).hex());
}, 30 * 1000);
