...
export declare class WalletClient {
     ...
     */
    getSentEvents(address: MaybeHexString, limit?: number, start?: number): Promise<Types.OnChainTransaction[]>;
    /**
     ...
     * @returns list of events
     */
    getReceivedEvents(address: string, limit?: number, start?: number): Promise<Types.Event[]>;
    /**
     ...
     * @returns transaction hash
     */
    createToken(account: AptosAccount, collection_name: string, name: string, description: string, supply: number, uri: string, royalty_payee_address?: MaybeHexString, royalty_points_denominator?: number, royalty_points_numerator?: number, property_keys?: Array<string>, property_values?: Array<string>, property_types?: Array<string>): Promise<string>;
    /**
    ...
    signAndSubmitTransactions(account: AptosAccount, txnRequests: Types.UserTransactionRequest[]): Promise<any[]>;
    signTransaction(account: AptosAccount, txnRequest: Types.UserTransactionRequest): Promise<Types.SubmitTransactionRequest>;
    estimateGasFees(account: AptosAccount, transaction: Types.UserTransactionRequest): Promise<string>;
    estimateCost(account: AptosAccount, transaction: Types.UserTransactionRequest): Promise<string>;
     ...
     */
    getTokenIds(address: string, limit?: number, start?: number): Promise<any[]>;
    /**
     ...
     */
    getTokens(address: string, limit?: number, start?: number): Promise<any[]>;
    /**
