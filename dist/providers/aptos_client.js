...
class AptosClient {
    ...
    async getAccount(accountAddress) {
        return this.client.accounts.getAccount(utils_1.HexString.ensure(accountAddress).hex());
    }
    /**
    ...
    async getAccountTransactions(accountAddress, query) {
        return this.client.transactions.getAccountTransactions(utils_1.HexString.ensure(accountAddress).hex(), query?.start?.toString(), query?.limit);
    }
    /**
    ...
    async getAccountModules(accountAddress, query) {
        ...
        const out = await (0, utils_1.paginateWithCursor)(f, accountAddress, 1000, query);
        // @ts-ignore
        return out;
    }
    /**
    ...
    async getAccountModule(accountAddress, moduleName, query) {
        return this.client.accounts.getAccountModule(utils_1.HexString.ensure(accountAddress).hex(), moduleName, query?.ledgerVersion?.toString());
    }
    /**
    ...
    async getAccountResources(accountAddress, query) {
        ...
        const out = await (0, utils_1.paginateWithCursor)(f, accountAddress, 9999, query);
        // @ts-ignore
        return out;
    }
    /**
    ...
    async getAccountResource(accountAddress, resourceType, query) {
        return this.client.accounts.getAccountResource(utils_1.HexString.ensure(accountAddress).hex(), resourceType, query?.ledgerVersion?.toString());
    }
    ...
    async getEventsByCreationNumber(address, creationNumber, query) {
        return this.client.events.getEventsByCreationNumber(utils_1.HexString.ensure(address).hex(), creationNumber.toString(), query?.start?.toString(), query?.limit);
    }
    /**
    ...
    async getEventsByEventHandle(address, eventHandleStruct, fieldName, query) {
        return this.client.events.getEventsByEventHandle(utils_1.HexString.ensure(address).hex(), eventHandleStruct, fieldName, query?.start?.toString(), query?.limit);
    }
    /**
