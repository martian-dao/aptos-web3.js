...
describe("MultiEd25519", () => {
    ...
    it("public key deserializes from bytes correctly", async () => {
        ...
        expect(hex_string_1.HexString.fromUint8Array(deserialzed.toBytes()).noPrefix()).toEqual(hex_string_1.HexString.fromUint8Array(pubKeyMultiSig.toBytes()).noPrefix());
    });
    ...
    it("signature deserializes from bytes correctly", async () => {
        ...
        expect(hex_string_1.HexString.fromUint8Array(deserialzed.toBytes()).noPrefix()).toEqual(hex_string_1.HexString.fromUint8Array(multisig.toBytes()).noPrefix());
    });
