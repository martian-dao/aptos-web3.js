...
exports.TypeTagParserError = exports.TypeTagParser = exports.stringStructTag = exports.StructTag = exports.TypeTagStruct = exports.TypeTagVector = exports.TypeTagSigner = exports.TypeTagAddress = exports.TypeTagU256 = exports.TypeTagU128 = exports.TypeTagU64 = exports.TypeTagU32 = exports.TypeTagU16 = exports.TypeTagU8 = exports.TypeTagBool = exports.TypeTag = void 0;
...
class TypeTagStruct extends TypeTag {
    ...
    isStringTypeTag() {
        if (this.value.module_name.value === "string" &&
            ...
            this.value.address.toHexString() === account_address_1.AccountAddress.fromHex("0x1").toHexString()) {
            return true;
        }
        return false;
    }
...
class TypeTagParser {
    ...
    parseTypeTag() {
        ...
        if (tokenVal === "string") {
            return new StructTag(account_address_1.AccountAddress.fromHex("0x1"), new identifier_1.Identifier("string"), new identifier_1.Identifier("String"), []);
        }
        if (tokenTy === "IDENT" && (tokenVal.startsWith("0x") || tokenVal.startsWith("0X"))) {
            ...
            const structTag = new StructTag(account_address_1.AccountAddress.fromHex(address), new identifier_1.Identifier(module), new identifier_1.Identifier(name), tyTags);
