...
class Tables {
    constructor(http) {
         ...
         */
        this.getTableItem = (tableHandle, data, params = {}) => this.http.request(Object.assign({ path: `/tables/${tableHandle}/items`, method: "POST", body: data, type: http_client_1.ContentType.Json, format: "json" }, params));
        this.http = http;
    }
}
