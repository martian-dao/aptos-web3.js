...
export declare class AptosClient {
     ...
     */
    static generateBCSSimulation(accountPublicKey: HexString, rawTxn: TxnBuilderTypes.RawTransaction): Uint8Array;
     ...
     *
     */
    simulateTransaction(accountPublicKey: MaybeHexString, rawTransaction: TxnBuilderTypes.RawTransaction, query?: {
