...
export declare class AptosClient {
     ...
     */
    generateTransaction(sender: MaybeHexString, payload: Gen.TransactionPayload, options?: Partial<Gen.SubmitTransactionRequest>): Promise<Gen.SubmitTransactionRequest>;
    /**
     ...
     */
    createSigningMessage(request: Gen.EncodeSubmissionRequest): Promise<string>;
     ...
     */
    signTransaction(accountFrom: AptosAccount, txnRequest: Gen.SubmitTransactionRequest): Promise<Gen.SubmitTransactionRequest>;
    /**
     ...
     */
    submitTransaction(signedTxnRequest: Gen.SubmitTransactionRequest): Promise<Gen.PendingTransaction>;
    /** Submits a transaction with fake signature to the transaction simulation endpoint that takes JSON payload. */
    simulateTransaction(accountFrom: AptosAccount, txnRequest: Gen.SubmitTransactionRequest): Promise<Gen.UserTransaction[]>;
    /**
     ...
     * @returns Transaction from mempool or on-chain transaction
     */
    getTransactionByVersion(txnVersion: BigInt): Promise<Gen.Transaction>;
    /**
     ...
     * ```
     */
    waitForTransactionWithResult(txnHash: string): Promise<Gen.Transaction>;
    /**
