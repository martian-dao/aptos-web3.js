...
export declare class TokenClient {
     ...
     */
    submitTransactionHelper(account: AptosAccount, payload: Types.TransactionPayload, options?: {
     ...
     * @returns A hash of transaction
     */
    createToken(account: AptosAccount, collectionName: string, name: string, description: string, supply: number, uri: string, royalty_payee_address?: MaybeHexString, royalty_points_denominator?: number, royalty_points_numerator?: number, property_keys?: Array<string>, property_values?: Array<string>, property_types?: Array<string>): Promise<Types.HexEncodedBytes>;
    /**
     ...
     * @returns A hash of transaction
     */
    offerToken(account: AptosAccount, receiver: MaybeHexString, creator: MaybeHexString, collectionName: string, name: string, amount: number, property_version?: number): Promise<Types.HexEncodedBytes>;
    /**
     ...
     * @returns A hash of transaction
     */
    claimToken(account: AptosAccount, sender: MaybeHexString, creator: MaybeHexString, collectionName: string, name: string, property_version?: number): Promise<Types.HexEncodedBytes>;
    /**
     ...
     * @returns A hash of transaction
     */
    cancelTokenOffer(account: AptosAccount, receiver: MaybeHexString, creator: MaybeHexString, collectionName: string, name: string, property_version?: number): Promise<Types.HexEncodedBytes>;
    /**
     ...
     */
    getTokenBalance(creator: MaybeHexString, collectionName: string, tokenName: string, property_version?: string): Promise<Types.Token>;
    /**
     ...
     * ```
     */
    getTokenBalanceForAccount(account: MaybeHexString, tokenId: any): Promise<Types.Token>;
}
