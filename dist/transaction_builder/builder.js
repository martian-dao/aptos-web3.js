...
var builder_utils_2 = require("./builder_utils");
Object.defineProperty(exports, "TypeTagParser", { enumerable: true, get: function () { return builder_utils_2.TypeTagParser; } });
...
class TransactionBuilderRemoteABI {
    ...
    async build(func, ty_tags, args) {
        ...
        const senderAddress = sender instanceof aptos_types_1.AccountAddress
            ? hex_string_1.HexString.fromUint8Array(sender.address)
            : sender;
