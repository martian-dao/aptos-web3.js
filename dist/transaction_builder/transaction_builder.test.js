...
test("serialize entry function payload with no type args", () => {
    ...
    const rawTxn = new aptos_types_1.RawTransaction(aptos_types_1.AccountAddress.fromHex(new hex_string_1.HexString(ADDRESS_3)), BigInt(0), entryFunctionPayload, BigInt(2000), BigInt(0), BigInt(TXN_EXPIRE), new aptos_types_1.ChainId(4));
