...
test('serialize script function payload with no type args', () => {
    const scriptFunctionPayload = new aptos_types_1.TransactionPayloadScriptFunction(aptos_types_1.ScriptFunction.natural(`${ADDRESS_1}::TestCoin`, 'transfer', [], [(0, bcs_1.bcsToBytes)(aptos_types_1.AccountAddress.fromHex(ADDRESS_2)), (0, bcs_1.bcsSerializeUint64)(1)]));
